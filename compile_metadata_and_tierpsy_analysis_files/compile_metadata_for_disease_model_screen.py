...
Script for generating metadata files for disease model screen
...
PROJECT_DIRECTORY = Path('/Volumes/behavgenom$/Tom/Data/Hydra/DiseaseModel/RawData')
...
if __name__ == '__main__':
    ...
    for count, day in enumerate(day_root_dirs):
        ...
        files_to_check = day_metadata_check(day_metadata, day, plate_size=96)
