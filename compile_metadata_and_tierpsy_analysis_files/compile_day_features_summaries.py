...
Script for compiling features and file names from Tierpsy analysis
"""
...
feat_files = [[file for file in day.glob('features*20210324*.csv')] for day in days]
fname_files = [[file for file in day.glob('filename*20210324*.csv')] for day in days]
