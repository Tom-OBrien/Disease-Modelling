...
ROOT_DIR = Path('/Users/tobrien/Documents/Imperial : MRC/Disease Model Screen/Results')
FEAT_FILE =  Path('/Users/tobrien/Documents/Imperial : MRC/Disease Model Screen/Results/features_summary_tierpsy_plate_filtered_traj_compiled.csv') 
FNAME_FILE = Path('/Users/tobrien/Documents/Imperial : MRC/Disease Model Screen/Results/filenames_summary_tierpsy_plate_filtered_traj_compiled.csv')
...
RAW_DATA_DIR = Path('/Users/tobrien/Desktop/StrainTimeSeries')
WINDOW_FILES = Path('/Users/tobrien/Documents/Imperial : MRC/Disease Model Screen/WindowSummaries')
ANALYSIS_DIR = Path('/Users/tobrien/Desktop/StrainTimeSeries/Results/Analysis')
...
if __name__ == '__main__':
    ...
    if which_stat_test == 'permutation_ttest':
        figures_dir = Path('/Users/tobrien/OneDrive - Imperial College London/DiseaseModelling_Paper_and_Final_Figures/t-test_permutation_strain_figures')
    ...
    meta.worm_gene.replace({'C43B7.2':'figo-1'},  
     ...
     # Take instances where N2 is in the gene list and treat these as the 
     # worm_strain value 
     # i.e. N2 in 'worm_gene' is read as OMG35, N2 or Day-2/-4 N2/OMG35                      
    meta.loc[meta.worm_strain=='N2','worm_gene']=meta.loc[meta.worm_strain=='N2','worm_strain']               

        
    # Filtering out plates I'm not interested in:
    ...
    #Double check replacement of name for paper
       ...
       # Again filter out bad wells, nans and unwanted features
        ...
        # Save colour maps as legends/figure keys for use in paper
            ...
            # stats using permutation t-tests or LMM tierpsy functions:
                ...
                # TODO: Uncomment lines below to generated 'clipped plots'
